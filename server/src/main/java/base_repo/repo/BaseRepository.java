package base_repo.repo;


import base_repo.annotations.Id;
import base_repo.annotations.Table;
import base_repo.annotations.Transient;
import base_repo.mappers.SimpleRowMapper;
import base_repo.models.Entity;
import base_repo.utils.EntityUtils;
import base_repo.utils.ReflectionUtils;
import base_repo.utils.StringUtils;
...
public abstract class BaseRepository<T extends Entity> {
    ...
    private String getInsertString(Map<String, Object> valuesMap){
        ...
        String values = String.join(", ", StringUtils.getNTimes("?", valuesMap.keySet().size()));
